...
export class ObservationDiff {
    ...
    {
        try {
            this.code.expected = JSON.stringify( {code: this.expected.code}, null, 4 );
            this.code.actual = JSON.stringify( {code: this.actual.code}, null, 4 );
        ...
        try {
            this.subject.expected = JSON.stringify( {subject: this.expected.subject}, null, 4 );
            this.subject.actual = JSON.stringify( {subject: this.actual.subject}, null, 4 );
